     ...
     <div>
      <Formik>
        <form className="w-[1000px] p-4 mx-auto mt-16 bg-slate-200" onSubmit={handleSubmit}>
          ...
          <button className="text-white bg-blue-700 hover:bg-blue-800 w-full mt-4 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrar</button>
